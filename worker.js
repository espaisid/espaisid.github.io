...
var DEFAULT_CACHE = 'espaisid-app-cache{{ site.time | date_to_xmlschema }}';
var AIP_CACHE = 'espaisid-aip-cache{{ site.time | date_to_xmlschema }}';
  ...
  event.waitUntil(
    caches.open(DEFAULT_CACHE).then(function(cache) {
      return cache.addAll([
        ...
        '/images/orange-de-angels-estella-acuarela-grayscale-espaisid.jpg',
        '/images/acuarela-angels-estella-walk-grayscale-espaisid.jpg',
        '/images/1-st-simultaneous-digital-art-show-flyer.jpg',
        '/images/la-tipografia-constructiva-per-a-titulars-d-artinpocket-ja-esta-disponible.jpg',
        '/images/top-sports-high-spirits-expo-espaisid.jpg',
        '/images/dreamings-circuit-de-motegui-japo-espaisid.jpg',
        '/images/figura-i-retrat-web-espaisid.jpg',
        '/images/jordi-pages-web-espaisid.jpg',
